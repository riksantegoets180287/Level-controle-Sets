...
function initDatabase(): DatabaseSchema {
  ...
  const initialPairs: StoredCardPair[] = [
    // Set 0 (Eindspel Level 1)
    {
      ...
      set_id: set0Id,
      card_a_text: "Is het programma waar je (huis)werk kunt vinden en inleveren",
      card_b_text: "Canvas",
      sort_order: 1,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is een plaatje van jouw gezicht",
      card_b_text: "Avatar",
      sort_order: 2,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is het programma waarmee je plaatjes of posters maakt",
      card_b_text: "Canva",
      sort_order: 3,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Dit doe je op wachtwoord.summacollege.nl",
      card_b_text: "Wachtwoord aanpassen",
      sort_order: 4,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Hieraan kun je OneDrive herkennen",
      card_b_text: "Blauw Wolkje",
      sort_order: 5,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is een keuzedeel waar je examen in kunt doen",
      card_b_text: "Digitale Vaardigheden",
      sort_order: 6,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Hier sla je jouw gemaakte werk op (opslaan)",
      card_b_text: "OneDrive",
      sort_order: 7,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is als je een opdracht niet goed genoeg hebt gemaakt",
      card_b_text: "Onvoldoende",
      sort_order: 8,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Dit doe je met de WAVE ID app",
      card_b_text: "MFA",
      sort_order: 9,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Hiermee kun je een screenshot maken",
      card_b_text: "Knipprogramma",
      sort_order: 10,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is een extra beveiliging van het Summa",
      card_b_text: "Printen",
      sort_order: 11,
      created_at: now,
      updated_at: now,
    },
    {
      id: crypto.randomUUID(),
      set_id: set0Id,
      card_a_text: "Is een app waar je jouw rooster kunt kijken",
      card_b_text: "Eduarte",
      sort_order: 12,
      created_at: now,
      updated_at: now,
